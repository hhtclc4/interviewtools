    ...
    render() {
        ...
        return (
            <div className="report-detail-questions-container ">
                <div className="rdq-question-stat shadow-sm mb-3">{/** for render 1 question contain atleast 2 choices */}
                    <div className="rdq-question-content">
                        This is content of questions
                    </div>
                    <hr />
                    <div className="rdq-question-calc container-fluid">
                        <div className="row"> {/**For each choice of a single question, each question has atleast 2 choices */}
                            ...
                            <div className="col-4 p-2 ">
                                <div className="question-accuracy-bar rounded "
                                    style={{
                                        backgroundColor: accuracyColor(),
                                        width: calcWidthBar(accuracy)
                                    }}
                                >
                                </div>{/**de tam, 1 question co 4 accuracy rieng cho tung choice */}
                            </div>
                        </div>
                    </div>
                </div>
