      ...
      <div className="hr-info-container container-fluid">
        ...
        <div className="hr-info-single-field">
          <div className="hr-info-combobox-field">
            <div className="hr-title-field font-weight-bold py-1 m-2 ">Braches</div>
            <Dropdown
              overlay={menu}
              trigger={["click"]}
              style={{ width: '100%' }}
        ...
        <div className="hr-info-single-field">
          <HREditable
            title="Destination"
            content="This is the destination"
          />
        </div>
        ...
        <div className="hr-info-double-field">
          <div className="row" style={{ width: '100%', margin: '0' }}>
            <div className="col-md-6 p-0">
              <div className="hr-info-combobox-field">
                <div className="hr-title-field font-weight-bold py-1 m-2 ">Type of work</div>
                <Dropdown
                  overlay={menu}
                  trigger={["click"]}
                  style={{ width: '100%' }}
            ...
            <div className="col-md-6 p-0">
              <div className="hr-info-combobox-field">
                <div className="hr-title-field font-weight-bold py-1 m-2 ">Sex</div>
                <Dropdown
                  overlay={menu}
                  trigger={["click"]}
                  style={{ width: '100%' }}
        ...
        <div className="hr-info-double-field d-flex flex-row container-fluid p-0">
          <div className="row" style={{ width: '100%', margin: '0' }}>
            ...
            <div className="col-md-6 p-0">
              <div className="hr-info-combobox-field">
                <div className="hr-title-field font-weight-bold py-1 m-2 ">Experience</div>
                <Dropdown
                  overlay={menu}
                  trigger={["click"]}
                  style={{ width: '100%' }}
        ...
        <div className="hr-title-field font-weight-bold py-1 m-2 ">Job description</div>
