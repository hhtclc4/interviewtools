    ...
    return (
      <div className="hr-interview-container container-fluid d-flex flex-column">
                ...
                <button
                  ...
                  style={
                    this.state.isFocusCreater || isFocusEmails
                      ? { zIndex: "15", position: "relative", display: "block" }
                      : null
                  }
                >
                  Create interview
        ...
        <div className="created-interviews d-flex flex-row flex-wrap">
          <div className="created-interview-container d-flex flex-row mr-2">
            <div className="interview-info d-flex flex-column justify-content-between">
              <div className="interview-name">
                Fresher Interview - First Time
              </div>
              <div className="interview-deadline">
                <FontAwesomeIcon icon={faClock} />
                <span className="interview-time ml-1">
                  Satuaday, March 28th 2020 - 8:00 AM
                </span>
              </div>
              <div className="interview-note">
                Choose 3-5 employees from 15 candidates{" "}
              </div>
            </div>
          ...
          <div
            className="created-interview-container d-flex flex-row mr-2"
            ref={this.outsideClick}
          >
            <div className="interview-info d-flex flex-column justify-content-between">
              <div className="interview-name">
                Fresher Interview - Second Time
              </div>
              <div className="interview-deadline">
                <FontAwesomeIcon icon={faClock} />
                <span className="interview-time ml-1">
