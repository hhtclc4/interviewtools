...
class UpgradeAcc extends React.Component {
  ...
  onSaveUpdateUserHandler = () => {
    this.props.onSaveUpdateUserHandler({ role_id: this.state.role_id });
    ...
    return (
      <div className="upgrade-acc-container">
        ...
        <div className="ua-role-img-container">
          <div
            className="role-symbol pr-3 pt-4 pb-2"
          ...
          >
            <img
              style={{ width: "80%" }}
              alt="HR"
              src={require("./images/HRstaff.png")}
            />
            <p className="text-center">
              <strong>as a Human Resources Staff</strong>
            </p>
          </div>
          <div
            className="role-symbol pr-3 pt-4 pb-2"
          ...
          >
            ...
            />
            <p className="text-center">
              <strong>as a Senior Engineer Interviewer</strong>
            </p>
          </div>
        </div>

        <div
          className="ua-pricing-container"
          ...
          <div className="ua-choose-plan">
            ...
            <div className="plan-choices d-flex flex-row">
              <div className="plan-container">
                ...
                <img alt="plan" src={require("./images/Advanced.png")} />
              ...
              <div className="plan-container mx-2">
                ...
                <img alt="plan" src={require("./images/Business.png")} />
                <div className="plan-price">
                  <strong>$5.99</strong>
                </div>
                <div className="plan-unit">
              ...
              {/*  */}
              <div className="plan-container">
                <div className="plan-type">Professional</div>
                <img alt="plan" src={require("./images/Professional.png")} />
                <div className="plan-price">
                  <strong>$9.99</strong>
                </div>
                <div className="plan-unit">
        ...
        <div
          className="ua-confirm-container text-center"
          style={isOpenPricing ? { display: "block" } : { display: "none" }}
        >
          <button
